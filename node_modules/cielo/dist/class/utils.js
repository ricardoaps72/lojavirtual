...
class Utils {
    ...
    parseHttpRequestError(options, data, response) {
        return {
            ...
            const req = https_1.request(options, (res) => {
                ...
                res.on('end', () => {
                    ...
                    if (res.statusCode && [200, 201].indexOf(res.statusCode) === -1)
                        return reject(this.parseHttpRequestError(options, data, res));
                    if (options.method === 'PUT' && chunks.length === 0)
                        return resolve(this.parseHttpPutResponse(res));
                    return resolve(Object.assign({}, this.parseHttpPutResponse(res), { data: camelcase_keys_1.default(response, { deep: true }) }));
                });
            });
            req.write(dataPost);
